...
class Display{
  ...
  */
  ...
  //static LCD1202 lcd(pinLcdRst, pinLcdCs, pinLcdMosi, pinLcdSck);  // RST, CS, MOSI, SCK
  static LCD1202 lcd;
...
//        animate = false;
  ...
  static void displayDrawNumber(byte symbol, byte offsetX, byte offsetY, byte blockSizeX, byte blockSizeY, byte animate){
