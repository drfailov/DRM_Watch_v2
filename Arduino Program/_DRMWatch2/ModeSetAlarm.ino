...
void modeSetAlarmLoop(){//y:13, 32, 
  ...
  displayDraw2DigitNumberWithFrame(/*x*/xOffset+39, /*y*/y, /*number*/eepromReadAlertHour(), /*selected*/selected == MODE_SET_ALARM_SELECTED_HOUR);  //hours
  displayDrawText(xOffset+59, y+4, 1, ":"); //:
  displayDraw2DigitNumberWithFrame(/*x*/xOffset+64, /*y*/y, /*number*/eepromReadAlertMinute(), /*selected*/selected == MODE_SET_ALARM_SELECTED_MINUTE);  //minutes
  y+=19;
  { //melody
